...
Процедура Бит_РасчетФОВ(ВыполнитьПринудительно)
	...
	ИначеЕсли ЭтотОбъект.ВидПЛ <> Перечисления.уатВидыПЛ._6С Тогда
		// Водители не автобусного участка: ночная смена целиком на дату заступления,
		// путевой только на слив топлива без часов в задании — без времени в табеле.
