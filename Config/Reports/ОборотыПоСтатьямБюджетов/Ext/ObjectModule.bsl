...
Процедура СформироватьНастройкиОтчета(МассивОтбора,СтруктураПредставлениеПолей,ОбновлениеПостроителя=Ложь)
	...
	"Валюта операции",
	"Количество",
	"Сумма в валюте упр. учета (" + Константы.ВалютаРегламентированногоУчета.Получить()+")",
...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	мНазваниеОтчета = "Обороты по статьям";
...
Процедура СоздатьОперацию(Расшифровка, ЭтотОтчет)
	...
	НоваяОперация.ПериодПланирования=Бюджетирование.ДатаНачалаПериода(ДатаОперации,Сценарий.Периодичность);
...
Процедура СформироватьОтчет(ДокументРезультат, ПоказыватьЗаголовок = Ложь, ВысотаЗаголовка = 0, ТолькоЗаголовок = Ложь) Экспорт
	...
	Если НЕ Бюджетирование.ЗадатьПараметрыОтбораПоКатегориям(ПостроительОтчета, мСтруктураДляОтбораПоКатегориям) Тогда
