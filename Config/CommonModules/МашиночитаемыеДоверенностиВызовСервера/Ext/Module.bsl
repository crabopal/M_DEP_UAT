...
//  * Значение - Булево
Функция ТребованияПроверкиМЧДНаКлиенте(Доверенности) Экспорт
	ТребованияПроверкиМЧДНаКлиенте = Новый Соответствие;
	Для Каждого Доверенность Из Доверенности Цикл
		ТребованияПроверкиМЧДНаКлиенте.Вставить(Доверенность, Не МашиночитаемыеДоверенности.ПроверенаВручную(Доверенность));
	КонецЦикла;
	Возврат ТребованияПроверкиМЧДНаКлиенте;
КонецФункции
...
Функция ДанныеДляПодписания(Знач Доверенности, Знач ОтпечаткиСертификатов, КонтекстДиагностики, УчитыватьСНИЛСДоверителя) Экспорт
