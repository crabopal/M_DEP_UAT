...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Если АктуализироватьБюджеты Тогда
		...
		Если (НЕ Результат.Следующий())
			...
			ИЛИ (Результат.ТекущаяГраницаФиксации<Бюджетирование.ДатаНачалаПериода(ДатаКонца,Сценарий.Периодичность)) Тогда
			...
			Движение.ГраницаФиксации=Бюджетирование.ДатаНачалаПериода(ДатаКонца,Сценарий.Периодичность);
