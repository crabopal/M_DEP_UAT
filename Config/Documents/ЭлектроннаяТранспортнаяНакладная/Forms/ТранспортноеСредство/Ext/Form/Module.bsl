...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли СтрНачинаетсяС(ИмяСобытия, "Запись_") Тогда
		Если ТипЗнч(Источник) = Тип("СправочникСсылка.ХранимыеДанныеЭПД") Тогда
			Для Каждого СтрокаПрицеп Из Прицепы Цикл
				Если Источник = СтрокаПрицеп.ХранимыеДанныеПрицеп Тогда
					...
					ВходящийКонтекст.Вставить("ГруппаДанных", "Прицеп");
					ВходящийКонтекст.Вставить("ТекущиеДанные", СтрокаПрицеп);
