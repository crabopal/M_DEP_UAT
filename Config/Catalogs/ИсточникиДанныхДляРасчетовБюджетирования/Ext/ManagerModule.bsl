Процедура ЗаполнитьДеревоРегистров(ДеревоРегистров) Экспорт
	ДеревоРегистров.ПолучитьЭлементы().Очистить();
	
	НовыйИсточник=ДеревоРегистров.ПолучитьЭлементы().Добавить();
	...
	Для Каждого МетаданныеРегистр Из Метаданные.РегистрыНакопления Цикл
		...
		РегистрИсточник=НовыйИсточник.ПолучитьЭлементы().Добавить();
		...
		РегистрИсточникТаблица=РегистрИсточник.ПолучитьЭлементы().Добавить();
		...
		Если МетаданныеРегистр.ВидРегистра = Метаданные.СвойстваОбъектов.ВидРегистраНакопления.Остатки Тогда
			...
			РегистрИсточникТаблицаПриход=РегистрИсточникТаблица.ПолучитьЭлементы().Добавить();
			...
			РегистрИсточникТаблицаРасход=РегистрИсточникТаблица.ПолучитьЭлементы().Добавить();
		...
		Иначе
			...
			РегистрИсточникТаблицаДвижение=РегистрИсточникТаблица.ПолучитьЭлементы().Добавить();
	...
	ЗапросИсточникТаблица=НовыйИсточник.ПолучитьЭлементы().Добавить();
