...
// Параметры:
//  Действие - См. РегистрСведений.ЖурналДействийПоЭДО.Действие
//  СвойстваДокумента - Структура:
//  * Ссылка - См. РегистрСведений.ЖурналДействийПоЭДО.ЭлектронныйДокумент
//  * Ответственный - См. РегистрСведений.ЖурналДействийПоЭДО.Ответственный
//  СостояниеДокумента - См. РегистрСведений.ЖурналДействийПоЭДО.СостояниеДокумента
//  ДатаИзменения - См. РегистрСведений.ЖурналДействийПоЭДО.ДатаИзменения
//  СвойстваСообщения - Структура:
//  * Ссылка - См. РегистрСведений.ЖурналДействийПоЭДО.Сообщение
//  * Статус - См. РегистрСведений.ЖурналДействийПоЭДО.СтатусСообщения
//  Комментарий - См. РегистрСведений.ЖурналДействийПоЭДО.Комментарий
Процедура ЗаписатьДействие(Действие, СвойстваДокумента, СостояниеДокумента, ДатаИзменения, СвойстваСообщения, Комментарий = "") Экспорт
