...
"Сбор данных превысил допустимое время.';en='Errors occurred while connecting to the a Cloud archive subsystem:"
"Data collection has exceeded the allowable time.'");
...
"%1';en='Errors occurred while connecting to the a Cloud archive subsystem:"
"%1'"),
