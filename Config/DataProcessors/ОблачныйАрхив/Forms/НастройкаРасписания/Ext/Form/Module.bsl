...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(1, НСтр("ru='Понедельник';en='Monday'"), Ложь);
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(2, НСтр("ru='Вторник';en='Tuesday'"), Ложь);
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(3, НСтр("ru='Среда';en='Wednesday'"), Ложь);
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(4, НСтр("ru='Четверг';en='Thursday'"), Ложь);
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(5, НСтр("ru='Пятница';en='Friday'"), Ложь);
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(6, НСтр("ru='Суббота';en='Saturday'"), Ложь);
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(7, НСтр("ru='Воскресенье';en='Sunday'"), Ложь);

	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Очистить();
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(1, НСтр("ru='Понедельник';en='Monday'"), Ложь);
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(2, НСтр("ru='Вторник';en='Tuesday'"), Ложь);
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(3, НСтр("ru='Среда';en='Wednesday'"), Ложь);
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(4, НСтр("ru='Четверг';en='Thursday'"), Ложь);
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(5, НСтр("ru='Пятница';en='Friday'"), Ложь);
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(6, НСтр("ru='Суббота';en='Saturday'"), Ложь);
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(7, НСтр("ru='Воскресенье';en='Sunday'"), Ложь);
...
Процедура КомандаЗаписатьИЗакрыть(Команда)
	...
	Если ПустаяСтрока(ЭтотОбъект.Вариант) Тогда
		ПоказатьОповещениеПользователя(
			,
			,
			НСтр("ru='Расписание не было настроено';en='Schedule not set'"),
