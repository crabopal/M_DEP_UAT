...
Процедура Сохранить(Команда)
	...
	ЗаписатьСохраненныеНастройки(ПараметрыЗакрытия);
...
&НаСервере
Функция ПрочитатьСохраненныеНастройки(ДанныеПоУмолчанию)
	Возврат ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить(ИмяФормы, "Отборы", ДанныеПоУмолчанию);
КонецФункции

&НаСервере
Процедура ЗаписатьСохраненныеНастройки(ПараметрыЗакрытия)
...
Процедура ЗаполнитьДеревоНастроек(ДанныеУчетныхЗаписей)
	...
	СохраненныеНастройки = ПрочитатьСохраненныеНастройки(ДанныеПоУмолчанию);
